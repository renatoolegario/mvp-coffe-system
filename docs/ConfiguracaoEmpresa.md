...
- Exibe aba de Logs com histórico persistido de execuções de webhooks e crons.
...
- Auditoria persistida das chamadas de webhook ASAAS e dos crons operacionais executados.
