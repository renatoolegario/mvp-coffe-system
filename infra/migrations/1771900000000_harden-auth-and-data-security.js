...
exports.up = async (pgm) => {
  ...
  pgm.sql(`
    ...
    UPDATE usuarios
    SET id_uuid = CASE
      WHEN id ~* '${UUID_REGEX}' THEN id::uuid
  ...
  pgm.createTable("auth_tokens", {
    ...
    expira_em: { type: "timestamp", notNull: true },
    revogado_em: { type: "timestamp" },
    ultimo_acesso_em: { type: "timestamp" },
  });

  pgm.createIndex("auth_tokens", "usuario_id");
  pgm.createIndex("auth_tokens", "expira_em");
